...
def load_weights(model, args):
    ...
    pretrained_dict = torch.load('{}/{}_{}_{}.pt'.format(
        args.model_path, args.base_model_name, args.start_epoch, args.lr))['state_dict']
...
if __name__ == "__main__":
    read_history("../../histories/history_r2plus1d_augmented_9class.txt")
