...
def augmentVideo(annotation_dict, labels_dict, data_dir='../datasets/mp4/', output_dir='../datasets/augmented-mp4/'):
    """
    ...
    with open('../datasets/augmented_annotation_dict.json', 'w') as fp:
...
def rotateVideo(path, output_dir, video_id, degree):
    ...
    while (video.isOpened()):
        ...
        rotation_matrix = cv2.getRotationMatrix2D(
            (frame_width / 2, frame_height / 2), degree, 1)
...
if __name__ == "__main__":
    ...
    labels_dict = "../datasets/labels_dict.json"
